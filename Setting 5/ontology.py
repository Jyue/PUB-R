...
# Cindy's modification:
# Add token - turn position

special_tokens = ['<pad>', '<go_r>', '<unk>', '<go_b>', '<go_a>',
                            '<eos_p>','<eos_u>', '<eos_r>', '<eos_b>', '<eos_a>', '<go_d>','<eos_d>',
                            '<sos_p>','<sos_u>', '<sos_r>', '<sos_b>', '<sos_a>', '<sos_d>'] + db_tokens

eos_tokens = {
    'posi': '<eos_p>', 'turn_num': '<eos_p>',
